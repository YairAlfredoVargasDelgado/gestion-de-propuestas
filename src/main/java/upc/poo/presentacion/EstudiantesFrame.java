...
public class EstudiantesFrame extends javax.swing.JFrame {
    ...
    private void cargarPracticasEmpresariales() {
        ArrayList<PracticaEmpresarial> pe = lpe.getAll(true);
        
        String col[] = {"Nombre", "Estado" };
        DefaultTableModel dtm = new DefaultTableModel(col, 0);

        for (PracticaEmpresarial e: pe) {
            if (e.getEstudiantes().stream()
                    .filter(_e -> _e.getIdentificacion().getNumero().equals(jTextField1.getText()))
                    .findAny()
                    .orElse(null) != null) {
                Object[] o = { e.getNombre(), e.getEstado() };
                dtm.addRow(o);
            }
        }
    ...
    private void cargarProyectosDeInvestigacion() {
        ArrayList<ProyectoDeInvestigacion> pi = lpi.getAll(true);

        String col[] = {"Nombre", "Estado" };
        DefaultTableModel dtm = new DefaultTableModel(col, 0);

        for (ProyectoDeInvestigacion e: pi) {
            if (e.getEstudiantes().stream()
                    .filter(_e -> _e.getIdentificacion().getNumero().equals(jTextField1.getText()))
                    .findAny()
                    .orElse(null) != null) {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Buscar propuestas");
        ...
        jMenu1.setText("Registrar propuesta");
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        new RegistroProyectoDeGradoDialog(null, true, 0).setVisible(true);
    }//GEN-LAST:event_jMenu1MouseClicked

    private void jMenu2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu2MouseClicked
        new IniciarSesionDialog(null, true).setVisible(true);
