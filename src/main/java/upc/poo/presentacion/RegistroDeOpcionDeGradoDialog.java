...
public class RegistroDeOpcionDeGradoDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro de opción de grado");

        jLabel2.setText("Nombre");

        jLabel3.setText("Descripción breve");

        jLabel4.setText("Línea de investigación");
        ...
        jLabel10.setText("No seleccionado");

        jButton2.setText("Buscar");

        jLabel11.setText("No seleccionado");
